 ...
 */
function cleancoded_wpcom_vip_maintenance_mode_do_not_respond_503_for_nagios( $should_set_503 ) {
...
add_filter( 'vip_maintenance_mode_respond_503', 'cleancoded_wpcom_vip_maintenance_mode_do_not_respond_503_for_nagios', 30 );
